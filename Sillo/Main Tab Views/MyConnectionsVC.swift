...
//MARK :IBDeclarations:
    ...
    let styles: [MessageInputBarStyle] = [.default,.facebook]
 ...
 //----------------------- Preseting Popup :=>
        ...
        if cameFrom == "ToShowPopup"
        {
            UserDefaults.standard.set(true, forKey: "popup1")
          let modalViewController = Popup1VC()
...
// FOR TOP TABLE  :
  ...
  // FOR Middle TABLE  :
       ...
       MidTable.register(CustomTableViewCell.self, forCellReuseIdentifier: "cell")
    ...
    BottomTable.register(CustomTableViewCell.self, forCellReuseIdentifier: "cell")
