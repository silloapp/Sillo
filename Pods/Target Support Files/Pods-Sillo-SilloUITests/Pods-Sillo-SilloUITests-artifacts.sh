...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  install_xcframework "${PODS_ROOT}/Giphy/GiphySDK/GiphyUISDK.xcframework" "" "false" "ios-arm64_armv7/GiphyUISDK.framework" "ios-arm64_x86_64-maccatalyst/GiphyUISDK.framework" "ios-arm64_i386_x86_64-simulator/GiphyUISDK.framework"
fi
